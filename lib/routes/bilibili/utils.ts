...
function iframe(aid: any, page?: any, bvid?: any) {
    return `<iframe id="myiframe" src="https://www.bilibili.com/blackboard/html5mobileplayer.html?${bvid ? `bvid=${bvid}` : `aid=${aid}`}${
        page ? `&page=${page}` : ''
    }&high_quality=1&autoplay=0"   style="transform: rotate(90deg); transform-origin: 50% 50%;width:400px;height:400px;"  scrolling="yes" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>`;
}
