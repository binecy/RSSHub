...
function iframe(aid: any, page?: any, bvid?: any) {
    return `<iframe id="myiframe" src="https://www.bilibili.com/blackboard/html5mobileplayer.html?${bvid ? `bvid=${bvid}` : `aid=${aid}`}${
        page ? `&page=${page}` : ''
    }&high_quality=1"   style="transform: rotate(90deg); transform-origin: 50% 50%;width:700px;height:410px;"  scrolling="yes" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>`;
}
